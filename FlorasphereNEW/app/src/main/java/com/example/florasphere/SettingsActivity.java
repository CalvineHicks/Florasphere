...
public class SettingsActivity extends Activity{
    protected void onCreate(Bundle savedInstanceState){
        ...
        UserPlantlist plantlist = UserPlantlist.getInstance(this);
        Plant p = new Plant( "African Violet", R.drawable.african_violet , 6, Plant.WaterAmt.LIGHT, Plant.LightAmt.FULL,
